...
/*  画出3个选项，提供速度选择：快速，正常，慢速。使用Tab键进行切换选项。 */
 ...
 circle(15,15,10); sprintf(ss,"  fast");     /* 画一个圆－－代表单选框，右边标注“fast” */
 outtextxy(30,15,ss);
        circle(15,55,10); sprintf(ss,"  normol");/* 画一个圆－－代表单选框，右边标注“normol” */
 outtextxy(30,55,ss);
        circle(15,95,10); sprintf(ss,"  slow");/* 画一个圆－－代表单选框，右边标注“slow” */
 outtextxy(30,95,ss);
...
void load1()/* 加载上一次保存的状态  */
{
 ...
 p2=(struct list *)malloc(LEN);        hit=1;
     p1=p2;
 head=p2;
 p2->x=(int)(str1[0])-30;
 p2->y=(int)(str1[1])-30;
